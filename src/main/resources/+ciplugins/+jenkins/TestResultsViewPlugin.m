    ...
    methods (Access=protected)
        function reportFinalizedSuite(plugin, pluginData)
            ...
            try
                ...
                testArtifactFile = fullfile(tempFolder, "matlabTestResults" + actionID + "_" + timestamp + "_" + uniqueToken + ".json");
                ...
                warning("ciplugins:jenkins:TestResultsViewPlugin:UnableToReportResults","Unable to report test results in the build summary. (Cause: %s)", e.message);
            end
        end
    end
end